    ...
    void showRounds(ArrayList<Round> rounds) {
        ...
        for (final Round round : rounds) {
            ...
            tv.setOnClickListener((View view) -> {
                        ...
                        Intent intent = new Intent(this, PariteActivity.class);
                        Bundle bundle = new Bundle();

                        ArrayList<String> listStr = new ArrayList<>();
                        ArrayList<Match> matches = (ArrayList<Match>) round.getMatches();

                        for (Match match : matches) {
                            String a = match.getDate() + "\n\n" +
                        ...
                        listStr.add(round.getMatches().toString());
                        bundle.putStringArrayList("partite", listStr);
